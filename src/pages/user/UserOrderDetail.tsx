  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="space-y-1 p-3 text-sm">
        ...
        <div className="flex justify-between pt-1 text-xs"><span>Payment</span><span className="uppercase">{o.payment_method === "fpx" ? "FPX (Online Transfer)" : (o.payment_method === "card" ? "Credit Card" : (o.payment_method ?? "—"))} · {o.payment_status}</span></div>
      </Card>
